...
import { AiOutlineDelete } from 'react-icons/ai';  // Importing Ant Design Icons for a delete icon
    ...
    return (
        <div className="bg-gray-100 min-h-screen py-8">
            <div className="container mx-auto px-4 md:px-8">
                ...
                <button onClick={addAlternative} className="mb-4 bg-[#6C0345] text-white px-4 py-2 rounded hover:bg-[#4E022E]">Add Alternative</button>
